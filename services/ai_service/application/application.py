...
def create_application() -> FastAPI:
    ...
    def on_startup() -> None:
        ...
        app.state.ollama_service = OllamaService(client)
...
def _build_client(settings: AIServiceSettings) -> OllamaClient:
    """Instantiate the Ollama client using environment settings."""
